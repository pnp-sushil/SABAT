...
G4RotationMatrix* rotation3 = new G4RotationMatrix();
 ...
 // SubMarine (Steel)
  ...
  G4LogicalVolume* logicSubmarineVolume = new G4LogicalVolume(solidSubmarineVolume,
                                                       fSubmarineMaterial,
                                                       "SubmarineVolume");
  new G4PVPlacement(rotation,G4ThreeVector(0.,100*cm,0),
...
//SourceGuide
  G4Cons* solidSourceGuide = new G4Cons("SourceGuide",10*cm,10.5*cm,10*cm,10.5*cm,25*cm,0.,twopi);
  G4LogicalVolume* logicSourceGuide = new G4LogicalVolume(solidSourceGuide,
                                                       fSourceGuideMat,
                                                       "SourceGuide");
  new G4PVPlacement(rotation1,G4ThreeVector(0.,-25*cm,0),
                         logicSourceGuide,"SourceGuide",
                         logicWorld,false,0);
  //Added by sks
  G4VisAttributes* sourceVisAtt= new G4VisAttributes(G4Colour(0.0,0.0,0.0));
  sourceVisAtt->SetForceWireframe(true);
  logicSourceGuide->SetVisAttributes(sourceVisAtt);
   
  G4Cons* solidInsideSourceGuide = new G4Cons("InsideSourceGuide",0*cm,10*cm,0*cm,10*cm,25*cm,0.,twopi);
  ...
  sourceInsVisAtt->SetForceSolid(true);
...
//ParticleGuide
  ...
  G4Trap* solidParticleGuide = new G4Trap("ParticleGuide",28*cm,42*deg,90*deg,10*cm,8*cm,8*cm,0*deg,10*cm,8*cm,8*cm,0*deg);
  ...
  G4LogicalVolume* logicParticleGuide = new G4LogicalVolume(solidParticleGuide,
                                                       fGuideMat,
                                                       "ParticleGuide");
  new G4PVPlacement(rotation2,G4ThreeVector(0.,-22.5*cm,39*cm+7*cm),
 ...
 // G4Trap* solidInsideParticleGuide = new G4Trap("InsideParticleGuide",28*cm,42*deg,90*deg,10*cm,7.75*cm,7.75*cm,0*deg,10*cm,7.75*cm,7.75*cm,0*deg);
  ...
  partInsVisAtt->SetForceSolid(true);
...
///G4Box* solidColimatorVolume = new G4Box("CollimatorVolume",10*cm,7.5*cm,7.5*cm); //15 × 15 × 20 cm 3
  ...
  // Low Carbon Steel
  G4Box* solidCollimatorVolume = new G4Box("CollimatorVolume",25*cm,10*cm+5*cm,25*cm);
  G4LogicalVolume* logicCollimatorVolume = new G4LogicalVolume(solidCollimatorVolume,
                                                       fCollimatorMat,
                                                        "CollimatorVolume");
  ...
  // Boric acid
  G4Box* solidCollimator2Volume = new G4Box("Collimator2Volume",25*cm,7.5*cm,25*cm);
  G4LogicalVolume* logicCollimator2Volume = new G4LogicalVolume(solidCollimator2Volume,
                                                       fCollimator2Mat,
                                                        "Collimator2Volume");
  new G4PVPlacement(rotation1,G4ThreeVector(0.,-75*cm,-28*cm-10*cm),
...
//Detector (LaBr3:Ce)
  ...
  for (G4int k=1; k<=fNbOfAbsor; k++) {
    ...
    G4Box* solidAbsor = new G4Box(matname,8.5*cm,7.5*cm,7.5*cm);
    ...
    G4ThreeVector position = G4ThreeVector(0.,-1*m+7.5*cm,-60.*cm-1*cm-12*cm);
  ...
  G4VisAttributes* solidVisAtt= new G4VisAttributes(G4Colour(1.0,1.0,1.0));
